class CaliHostDashboardBid extends Polymer.MutableData(Polymer.Element) {
  static get is() {
    return 'gdq-dash-host-bid';
  }
...
customElements.define(CaliHostDashboardBid.is, CaliHostDashboardBid);
